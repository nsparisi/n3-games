...
public class InputController
{
    ...
    public static bool GetDown()
    {
        return 
            ...
            OuyaInputManager.GetButton("DPD", OuyaSDK.OuyaPlayer.player1) || 
            OuyaInputManager.GetAxis("LY", OuyaSDK.OuyaPlayer.player1) < -0.25f;
    }
    ...
    public static bool GetUp()
    {
        return 
            ...
            OuyaInputManager.GetButton("DPU", OuyaSDK.OuyaPlayer.player1) ||
            OuyaInputManager.GetAxis("LY", OuyaSDK.OuyaPlayer.player1) > 0.25f;
    }
    ...
    public static bool GetLeft()
    {
        return 
            ...
            OuyaInputManager.GetButton("DPL", OuyaSDK.OuyaPlayer.player1) ||
            OuyaInputManager.GetAxis("LX", OuyaSDK.OuyaPlayer.player1) < -0.25f;
    }
    ...
    public static bool GetRight()
    {
        return 
            ...
            OuyaInputManager.GetButton("DPR", OuyaSDK.OuyaPlayer.player1) ||
            OuyaInputManager.GetAxis("LX", OuyaSDK.OuyaPlayer.player1) > 0.25f;
    }
    ...
    public static bool GetPlayerInteractDown()
    {
        return Input.GetKeyDown(KeyCode.L) || 
            OuyaInputManager.GetButtonDown("A", OuyaSDK.OuyaPlayer.player1);
    }
}
